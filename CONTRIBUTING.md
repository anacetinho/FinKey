# Contributing to FinKey

It means so much that you're interested in contributing to FinKey! Seriously. Thank you. The entire community benefits from these contributions!

## House Rules

- Before contributing, familiarize yourself with our project conventions. You should read through our [Project Conventions Rule](.cursor/rules/project-conventions.mdc), which is intended for LLMs, but is also an excellent primer on how we write code for FinKey.
...
- Before contributing, please check if it already exists in [issues](https://github.com/[your-username]/finkey/issues) or [PRs](https://github.com/[your-username]/finkey/pulls)
...
As we continue to improve this project, we recommend checking our issues and project documentation to get a better idea of _what_ to contribute.

In general, _full features_ and improvements that enhance the personal finance experience are the most valuable contributions.
...
2. Local Development
   - [Mac Setup Guide](https://github.com/[your-username]/finkey/wiki/Mac-Dev-Setup-Guide)
   - [Linux Setup Guide](https://github.com/[your-username]/finkey/wiki/Linux-Dev-Setup-Guide)
   - [Windows Setup Guide](https://github.com/[your-username]/finkey/wiki/Windows-Dev-Setup-Guide)
